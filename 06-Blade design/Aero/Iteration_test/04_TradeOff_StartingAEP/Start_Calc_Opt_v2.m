function time_to_start = Start_Calc_Opt_v2(data,chord, twist, J, Operation)
...
idx = find(Operation.Lambda~=0,1);
data.lambda_start = Operation.Lambda(idx); %The lambda at starting wind speed will be the one computed before
